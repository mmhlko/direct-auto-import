...
export default function HeroSection() {
  ...
  <div className="absolute inset-0 z-0">
    <Image
      ...
      sizes="100vw"
    />
    <div className="absolute inset-0 z-10" style={{ background: GRADIENT_LEFT }} />
    <div
  ...
  {/* Контент и машина через grid */}
  <div className="relative z-20 container mx-auto px-4 py-12 md:py-24 grid grid-rows-[auto_1fr] md:grid-rows-1 md:grid-cols-5 gap-8 items-center">
    
    {/* Текст */}
    <div className="flex flex-col justify-center text-center md:text-left md:col-span-2 row-start-1 md:row-auto">
      <motion.h1
...
{/* Машина */}
<div className="row-start-2 md:row-auto md:col-span-3 flex justify-center md:justify-end">
          <Image
            src={AUDI_Q3_PNG}
            alt="Audi Q3 2020"
            width={1440}
            height={740}
            className="object-cover object-bottom md:object-center py-12"
            priority
